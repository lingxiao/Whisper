...
class PlayListHeader: UIView {
    ...
    func config( with club: Club? ){
        self.club = club
        ImageLoader.shared.injectImage(from: club?.fetchThumbURL(), to: self.imageView){ _ in return }
    }
    ...
    func setViewConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            self.heightAnchor.constraint(equalTo: containerView.heightAnchor, constant:-20)
        ])
        ...
        imageViewBottom = imageView.bottomAnchor.constraint(equalTo: containerView.bottomAnchor, constant:-20)
